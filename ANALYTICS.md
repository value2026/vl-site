...
### 2a. simulation_completed

Fires when the user explicitly finishes the simulation tasks or reaches the end state.

- **Category**: `experiment`
- **Action**: `simulation_completed`
- **Parameters**: `vl_exp_id`, `vl_exp_name`

### 2b. parameter_changed

Fires when the user changes a simulation parameter (e.g. adjusting a slider, selecting an option).

- **Category**: `experiment`
- **Action**: `parameter_changed`
- **Parameters**: `vl_param_name`, `vl_param_value`

### 2c. step_changed

Fires when the user moves to another experiment step within the simulation.

- **Category**: `experiment`
- **Action**: `step_changed`
- **Parameters**: `vl_step_name`, `vl_step_number`

### 2d. prediction_submitted

Fires when the user submits a prediction before running a simulation step.

- **Category**: `experiment`
- **Action**: `prediction_submitted`
- **Parameters**: `vl_prediction_value`

### 2e. observation_added

Fires when the user records an observation in the simulation notebook or log.

- **Category**: `experiment`
- **Action**: `observation_added`
- **Parameters**: `vl_observation_data`

### 2f. result_generated

Fires when the simulation calculates and produces a final result based on user inputs.

- **Category**: `experiment`
- **Action**: `result_generated`
- **Parameters**: `vl_result_data`

### 2g. report_downloaded

Fires when the user downloads a report or certificate of their simulation run.

- **Category**: `experiment`
- **Action**: `report_downloaded`
- **Parameters**: `vl_report_type`

### 2h. feedback_submitted

Fires when the user submits feedback on the simulation or experiment.

- **Category**: `experiment`
- **Action**: `feedback_submitted`
- **Parameters**: `vl_feedback_rating`, `vl_feedback_comments`

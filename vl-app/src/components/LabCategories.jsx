  ...
  return (
    <section id="lab-categories" className="relative py-8 md:py-12 overflow-hidden bg-white scroll-mt-20">
      ...
      <div className="absolute top-10 left-[-5%] opacity-10 pointer-events-none">
        <Atom className="w-[350px] h-[350px] text-blue-600" strokeWidth={0.5} />
      </div>
      <div className="absolute top-20 right-[-2%] opacity-10 pointer-events-none">
        <Microscope className="w-[300px] h-[300px] text-blue-600" strokeWidth={0.5} />
      </div>

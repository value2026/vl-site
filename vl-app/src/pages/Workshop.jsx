      ...
      <section className="py-16 bg-slate-900 text-slate-300 border-t border-slate-800">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="bg-slate-800/50 rounded-3xl p-8 md:p-10 border border-slate-700 shadow-xl relative overflow-hidden">
              ...
              <div className="mt-6">
                <Link to="/nodal-centres" className="inline-flex items-center gap-2 text-blue-400 font-semibold hover:text-blue-300 transition-colors">
                  Learn more about Nodal Centres <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </div>
            ...
            <div className="text-center space-y-6">
              ...
              <button 
                ...
                className="inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-white text-slate-900 font-bold hover:bg-slate-100 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
